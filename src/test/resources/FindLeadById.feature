Feature: Find lead by Id
  Scenario: Find lead by Id with correct Id
    When a user finds the lead by Id 00Q3i000002MKLeEAO
  ...
  Scenario: Find lead by Id that does not exist
    When a user finds the lead by Id 00Q3i000002MKLeEA
    Then the status code is 404

  Scenario: Find lead by Id that is malformed
    When a user finds the lead by Id 00Q3i000002MKLeEA1
